...
@Embeddable
public class TblEventParticipantId implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblEventParticipantId))
			return false;
		TblEventParticipantId castOther = (TblEventParticipantId) other;
