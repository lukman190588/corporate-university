...
@Embeddable
public class TblEventEvaluateId implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7444696876463105615L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblEventEvaluateId))
			return false;
		TblEventEvaluateId castOther = (TblEventEvaluateId) other;
